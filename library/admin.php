...
function bones_custom_admin_footer() {
	_e( '<span id="footer-thankyou">Developed by <a href="http://cabshare" target="_blank">Cabshare</a></span>. Built using <a href="http://cabshare.in" target="_blank">Bones</a>.', 'bonestheme' );
}
