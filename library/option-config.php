			...
			$this->sections[] = array(
				...
				'fields' => array (
					...
					array (
					    ...
					    'type'     => 'media', 
					    'url'      => true,
					    'title'    => __('Logo', 'brew-framework')
					),
					array (
					    'id'          => 'opt-slides',
					    'type'        => 'slides',
					    'title'       => __('Slides Options', 'brew-framework'),
					    'subtitle'    => __('Unlimited slides with drag and drop sortings.', 'brew-framework'),
					    'desc'        => __('This field will store all slides values into a multidimensional array to use into a foreach loop.', 'brew-framework'),
					    'placeholder' => array(
					        'title'           => __('This is a title', 'brew-framework'),
					        'description'     => __('Description Here', 'brew-framework'),
					        'url'             => __('Give us a link!', 'brew-framework'),
					    ),
					),
					array(
					    'id'       => 'facebook-text',
					    'type'     => 'text',
					    'title'    => __('Facebook', 'brew-framework')
					),	
					array(
					    'id'       => 'twitter-text',
					    'type'     => 'text',
					    'title'    => __('Twitter', 'brew-framework')
					),	
					array(
					    'id'       => 'pinterest-text',
					    'type'     => 'text',
					    'title'    => __('Pinterest', 'brew-framework')
					),	
					array(
					    'id'       => 'googleplus-text',
					    'type'     => 'text',
					    'title'    => __('Googleplus', 'brew-framework')
					),	
					array(
					    'id'       => 'dribbble-text',
					    'type'     => 'text',
					    'title'    => __('Dribbble', 'brew-framework')
					),			
				),
			);
